...
# 设置每小时执行一次
0 */1 * * *  python3 /home/dowloadSQLFile.py -host='127.0.0.1' -port=3306 -user='root' -pwd='123456' -db='test' -table='images' -start=0 -end=2000 -mkdir='c/' >> /home/dowloadSQLFile.log 2>&1
```
```diff
