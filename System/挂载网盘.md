...
| --box-client-id   string                                   	| Box应用程序客户端ID。                                                                                                                                                            	|
| --box-client-secret   string                               	| Box App客户端机密                                                                                                                                                                	|
...
| --cache-workers   int                                      	| 有多少工人应并行运行以下载块。 （默认为4）                                                                                                                                       	|
...
| --chunker-remote   string                                  	| 远程到块/ unchunk。                                                                                                                                                              	|
...
| --drive-client-id   string                                 	| Google应用程序客户端ID                                                                                                                                                           	|
...
| --dropbox-client-id   string                               	| Dropbox应用程序客户端ID                                                                                                                                                          	|
| --dropbox-client-secret   string                           	| Dropbox App客户端机密                                                                                                                                                            	|
...
| --gphotos-client-id   string                               	| Google应用程序客户端ID                                                                                                                                                           	|
...
| --tardigrade-satellite-address   <nodeid>@<address>:<port> 	| 卫星地址。自定义卫星地址应与以下格式匹配： <nodeid>@<address>:<port>.   (default "us-central-1.tardigrade.io")                                                                   	|
