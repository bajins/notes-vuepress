...
| 区间类型 | 表示法 | 等价不等式 | 端点是否包含 | 图示示意（数轴） |
| :--- | :--- | :--- | :--- | :--- |
| **闭区间** | `[a, b]` | a ≤ x ≤ b | 包含两端 | ●————● |
| **开区间** | `(a, b)` | a < x < b | 不含两端 | ○————○ |
| **左闭右开** | `[a, b)` | a ≤ x < b | 含左端点，不含右端点 | ●————○ |
| **左开右闭** | `(a, b]` | a < x ≤ b | 不含左端点，含右端点 | ○————● |
| **无限区间** | `[a, +∞)` | x ≥ a | 含左端点，无穷大不可及 | ●————→ |
| | `(a, +∞)` | x > a | 不含左端点 | ○————→ |
| | `(-∞, b]` | x ≤ b | 含右端点 | ←————● |
| | `(-∞, b)` | x < b | 不含右端点 | ←————○ |
| | `(-∞, +∞)` | 全体实数 | 两端均不可及 | ←————→ |
...
* [https://docs.pocoproject.org/current/Poco.Glob.html](https://docs.pocoproject.org/current/Poco.Glob.html)
...
+ [https://github.com/Perl](https://github.com/Perl)
    ...
    + [https://github.com/StrawberryPerl](https://github.com/StrawberryPerl)
